...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative px-6 md:px-12 lg:px-24 py-12 md:py-16 border-t border-current/10"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          {/* Brand */}
          <div className="footer-item">
            <span className="font-display text-2xl md:text-3xl font-800 tracking-tighter">
        ...
        <div className="mt-16 md:mt-24 footer-item">
          <h2 className="font-display text-[15vw] md:text-[12vw] font-800 leading-none tracking-tighter opacity-5 select-none">
            ZeroDev
          </h2>
        </div>
      </div>
