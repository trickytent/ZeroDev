    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={textRef} className="max-w-5xl">
          <p className="font-display text-2xl md:text-4xl lg:text-5xl font-500 leading-snug tracking-tight">
            {splitIntoWords(aboutText)}
          </p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 md:mt-32 pt-16 border-t border-current/10">
          {stats.map((stat, i) => (
            <div key={i} className="stat-item">
              ...
              <p className="font-body text-sm opacity-50 mt-2 tracking-wide">
                {stat.label}
              </p>
            </div>
          ))}
